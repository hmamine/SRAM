...
#	write.table(DT.m, "manresa_metrics_full.txt", sep="\t")
#	write.table(DT_sub, "manresa_metrics_sub.txt", sep="\t")
#	write.table(as_data_frame(graph.mb), "manresa_network_full.txt", sep="\t")
#	write.table(as_data_frame(selecG), "manresa_network_sub", sep="\t")
#	write.table(DT_m3, "manresa_sub_relative.txt", sep="\t")
