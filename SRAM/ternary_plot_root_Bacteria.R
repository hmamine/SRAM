...
print (" These R scripts display the ternary plot indicated in Fig 3C and corresponding venn diagram in 2D")
...
# upload and prepare phyloseq objects***
	...
	physeqB2=subset_samples( physeqB1, SampleType == "Root" )
